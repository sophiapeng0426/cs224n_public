...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.encoder = nn.LSTM(input_size = embed_size, hidden_size = self.hidden_size, bidirectional=True) # dropout=self.dropout_rate,
        self.decoder = nn.LSTM(input_size = embed_size + self.hidden_size, hidden_size=self.hidden_size)
